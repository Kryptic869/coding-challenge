...
|-|-|-|
|Create a jackpot|POST|/api/jackpots|
|Get all jackpots|GET|/api/jackpots|
|Create a bet|POST|/api/bets|
...
Using Java records because they are:

* immutable by default
* less boilerplate code 
* Perfect for DTOs
* Showing the clear intent of being a data carrier only
...
For the models (Entities):

BigDecimal → never use double for money

Instant → timezone-safe timestamps

Defaults avoid null issues
