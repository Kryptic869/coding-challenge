...
The project includes basic service-layer tests which cover two main services:

- Bet placement logic
- Filtering and ordering of win results

Via Maven, these tests can be run using:

```bash
mvn test
```

These tests can be found within the `src/test/java/com/example/jackpot_service/service` folder.
